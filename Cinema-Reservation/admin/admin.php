...
<body>
    ...
    $sql1 = "SELECT * FROM feedbackTable";
    ...
    $userNo=mysqli_num_rows(mysqli_query($link, "SELECT * FROM user"));
    ?>
    ...
    <div class="admin-container">
        <div class="admin-section admin-section1 ">
            <ul>
                <li><i class="fas fa-sliders-h"></i><a href="admin.php">Dashboard</a></i></li>
                        ...
                        if($result = mysqli_query($link, $sql1)){
                            if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "                            <div class=\"admin-panel-section-booking-response\">\n";
                                    echo "                                <i class=\"fas fa-check accept-booking\" title=\"Verify booking\"></i>\n";
                                    echo "                                <a href='deleteFeedback.php?id=".$row['msgID']."'><i class=\"fas fa-times decline-booking\" title=\"Reject booking\"></i></a>\n";
                                    echo "                            </div>\n";
                                    echo "                            <div class=\"admin-panel-section-booking-info\">\n";
                                    echo "                                <div>\n";
                                    echo "                                    <h4><h4>NAME-<h4>". $row['senderfName'] ."</h4>\n";
                                
                                    echo "                                    <h4>". $row['senderlName'] ."</h4>\n";
                                        echo "                                    <i class=\"fas fa-circle \"></i>\n";
                                  
                                    echo "                                    <h4><h3>Email-</h3><h4>". $row['sendereMail'] ."</h4>\n";
                                
                                
                                    echo "                                </div>\n";
                                    echo "                                <div>\n";
                                    echo "                                    <h4>FeedBack:</h4><br>\n";
                        ...
                        if($result = mysqli_query($link, $sql2)){
                            if(mysqli_num_rows($result) > 0){
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo "                            <div class=\"admin-panel-section-booking-response\">\n";
                                    echo "                                <i class=\"fas fa-check accept-booking\" title=\"Verify booking\"></i>\n";
                                    echo "                                <a href='deleteMovie.php?id=".$row['movieID']."'><i class=\"fas fa-times decline-booking\" title=\"Reject booking\"></i></a>\n";
                                    echo "                            </div>\n";
                                    echo "                            <div class=\"admin-panel-section-booking-info\">\n";
                                    echo "                                <div>\n";
                                    echo "                                    <h4><h4>NAME-<h4>". $row['movieTitle'] ."</h4>\n";
                                
                                    echo "                                    <h4>". $row['language'] ."</h4>\n";
                                        echo "                                    <i class=\"fas fa-circle \"></i>\n";
