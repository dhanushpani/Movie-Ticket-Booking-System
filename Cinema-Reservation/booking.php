                ...
                <form action="payment.php" method="POST">
                   ...
                   <input placeholder="Date" type="date" name="date" required>
                    ...
                    <select name="Location" required>
                        ...
                        <option value="PVR-brookfield">PVR-brookfield</option>
                        <option value="Rockline">Rockline</option>
                        <option value="inox-Mantri">inox-Mantri</option>
                        <option value="PVR-Saphire">PVR-Saphire</option>
                        <option value="Cinipolis-Nitte">Cinipolis-Nitte</option>
                        <option value="Gopalan-Byapnahalli">Gopalan-Byapnahalli</option>
                    </select>

                    <select name="Seat" required>
                        <option value="" disabled selected>NUMBER OF SEAT</option>
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        VALUES (        '".$row['movieTitle']."',
                                        ...
                                        '".$_POST["Location"]."',
                                        '".$_POST["Seat"]."')";
                        $res= mysqli_query($link,$insert_query);                                        
                        }
                    ?>
                </form>
            </div>
